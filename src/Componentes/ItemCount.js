...
const foto_1 = 'producto_6.png';
    ...
    const [cant_pedido, setcant_pedido] = useState(parseInt(props.cant_inicial,10));
   ...
   const  onAdicPedido =() => {
    ...
    return (
             ...
             <button onClick={ onDisPedido} className="btn btn-danger" >-</button>            
             <input   type="number"  key="cant_ped" className="form-control-sm" value={ cant_pedido} />  
             <button onClick={ onAdicPedido} className="btn btn-danger"   >+</button>
             </div>
             ...
             <div>
                 ...
                 <button   className="btn btn-primary" onClick={addCarrito}  > Agregar carrito</button>
                 </div>
                 <div style={styleVista}>
                 <button   className="btn btn-warning" onClick={onVerCarrito} >Ir al carrito</button>  
                </div>
             </div>
